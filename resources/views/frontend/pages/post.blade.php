        ...
        <div class="row justify-content-center">
            <div class="col-xl-6 col-lg-8 col-md-10">
                <div class="breadcrumb__wrap__content">
                    <h2 class="title">{{ $blog_dat->title }}</h2>
            ...
            <div class="col-lg-8">
                <div class="standard__blog__post">
                    ...
                    <div class="blog__details__content services__details__content">
                        ...
                        <h2 class="title">{{ $blog_dat->title }}</h2>
                        <p>{{ $blog_dat->desc }}</p>
                        <p>{{ $blog_dat->short_desc }}</p>
                    </div>
                    <div class="blog__details__bottom">
                        <ul class="blog__details__tag">
                            <li class="title">Tag:</li>
                            <li class="tags-list">
                                @foreach(explode(',', $blog_dat->tags) as $tag)
                                    <a href="#">{{ $tag }}</a>
                                @endforeach
                            </li>
                        </ul>
            ...
            <div class="col-lg-4">
                <aside class="blog__sidebar">
                    ...
                    <div class="widget">
                        ...
                        <ul class="rc__post">
                            @foreach($blogs_dat as $blog)
                            <li class="rc__post__item">
                                <div class="rc__post__thumb">
                                    <a href="{{ route('load.blog', $blog->id) }}"><img src="{{ $blog->img }}" alt=""></a>
                                </div>
                                <div class="rc__post__content">
                                    <h5 class="title"><a href="{{ route('load.blog', $blog->id) }}">{{ $blog->title }}</a></h5>
